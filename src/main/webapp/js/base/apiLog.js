$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [		
			...
			{ label: '系统名称', name: 'userName', width: 45 },
			{ label: '系统ip地址', name: 'ipAddr', width: 60,sortable: false },
			{ label: '日志信息', name: 'logId', width: 40,sortable: false,formatter: function(value, options, row){
